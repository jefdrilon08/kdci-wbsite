		...
		<div class="post_box" style="border:1px white solid"> 
			...
			<div id="strategy" class="col_b float_f" style="width:900px;padding-left:5px; border-bottom:thin black dashed;margin-top:15px ">
			  ...
			  <div style="width:400px;float:left">
						<table><tr><td><p style="font-family:Arial, Helvetica, sans-serif;font-size:25px;color:#9dcf56;width:170px">M.A.R.C.E.L.O</p></td><td><p style="font-family:Arial, Helvetica, sans-serif;font-size:15px"></p></td></tr></table>
			...
			<div id="pangakosapagtataya" class="col_b float_f" style="width:900px;padding-left:5px; border-bottom:thin black dashed;margin-top:15px ">
						...
						<table><tr><td><p style="font-family:Arial, Helvetica, sans-serif;font-size:25px;color:#9dcf56;width:255px">Pangako sa Pagtataya</p></td><td><p style="font-family:Arial, Helvetica, sans-serif;font-size:15px"></p></td></tr></table>
