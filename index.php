...
<div id="templatemo_wrapper">
      ...
      <!-- <?php $loader->loadSlider(); ?>    -->
	        ...
	        <div id="slider" class="nivoSlider">
	         <!--    <a href="#"><img  src="images/slider/01.jpg" alt="Slider 01" title="<p style=color:white>This is a sample image for slider</p>" /></a> -->
	            <a href="#"><img  src="images/slider/01.JPG" alt="Slider 01" title="<p style=color:white>This is a sample image for slider</p>" /></a>
	            <a href="#"><img src="images/slider/02.JPG" alt="Slider 02" title="<p style=color:white>This is a sample image for slider</p>" /></a>
    ...
    <div >
       <div class="col_5 float_l" >
        	...
        	<p style= "font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:100"><a href="#"><b>In the Service of the Urban Poor</b></a><br><p><i> Fernando T. Aldaba</i><br>Chair, Board of Trustees</p></p>
