...
class loader{
	...
	public function steeringCommitee($db){
		...
		echo $strSc;*/
					...
					while($row1=$res1->fetch(PDO::FETCH_ASSOC)){
					$strSc1.='<tr><td width="110px"><img src="administrator/images/mng/SC/'.$row1['img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row1['steerName'].'</strong><br/><br/>'.$row1['steerPosition'].'</td></tr>';
					}
					$strSc1.='</table>';
					echo $strSc1;
					...
					while($row=$res->fetch(PDO::FETCH_ASSOC)){
					$strSc.='<tr><td width="110px"><img src="administrator/images/mng/SC/'.$row['img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row['steerName'].'</strong><br/><br/>'.$row['steerPosition'].'</td></tr>';
					}
					$strSc.='</table>';
					echo $strSc;
	}
	...
	public function FieldManager($db){
					...
					while($row=$res->fetch(PDO::FETCH_ASSOC)){
					$strFm.='<tr><td width="110px"><img src="administrator/images/mng/FM/'.$row['fm_img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row['fm_name'].'</strong><br/><br/>'.$row['fo'].'</td></tr>';
					}
					$strFm.='</table>';
					echo $strFm;
					...
					while($row2=$res2->fetch(PDO::FETCH_ASSOC)){
					$strFm2.='<tr><td width="110px"><img src="administrator/images/mng/FM/'.$row2['fm_img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row2['fm_name'].'</strong><br/><br/>'.$row2['fo'].'</td></tr>';
					}
					$strFm2.='</table>';
					echo $strFm2;
	...
	public function SbookKeeper($db){
					...
					while($row2=$res2->fetch(PDO::FETCH_ASSOC)){
					$strSbk2.='<tr><td width="110px"><img src="administrator/images/mng/SBK/'.$row2['sbk_img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row2['sbk_name'].'</strong><br/><br/>'.$row2['cluster'].'</td></tr>';
					}
					$strSbk2.='</table>';
					echo $strSbk2;
	...
	public function OMCM($db){
						...
						while($row=$res->fetch(PDO::FETCH_ASSOC)){
						$stromcm.='<tr><td width="110px"><img src="administrator/images/mng/OMCM/'.$row['omcm_img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row['omcm_name'].'</strong><br/><br/>'.$row['pos'].'</td></tr>';
						}
						$stromcm.='</table>';
						echo $stromcm;
		...
		public function fieldOffice($db){
					...
					//	$a = 'select * , count(fo_id) from tblfo';
						...
						$strfo.='<br/><p style="font-family:Arial, Helvetica, sans-serif;font-size:25px;color:black;">'.$row['cluster_name'].'</p>';
							...
							$strfo.='<tr><td width="110px"><img src="administrator/images/mng/FO/'.$row2['fo_img'].'" style="margin:5px 5px 5px 5px ; width:100px;height:100px"/></td><td style="padding-left:3px" ><strong>'.$row2['fo_name'].'</strong><br/><br/>'.$row2['fo_add'].'<br/>'.$row2['fo_contact'].'</td></tr>';
							}
							$strfo.='</table>';
						}
						echo $strfo;
