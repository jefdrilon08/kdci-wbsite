<?php
	...
	$iter=1;
	$sqlVersion="Select * from tblvmc where vmcId=4";
...
<div id="templatemo_wrapper">
    ...
    <form name="frmvision" method="post">
    	<h2 align="center">Pangako sa Pagtataya(Pamamaraan)</h2>
    	    	<input type="hidden" name="abtId" id="abtId" value="<?php echo $strId;?>">
			    <div style="float:left;width:440px; margin-left:1px" align="center"  >
			    	Filipino
		             <textarea style="width:410px" name="txtAbttag" id="txtAbttag"  rows="20"><?php echo $strTag;?></textarea>
			    </div>
			    <div style="float:right;width:440px;" align="center">
			    English
					<textarea style="width:410px" name="txtAbtEng" id="txtAbtEng" rows="20"><?php echo $strEng;?></textarea>
			    </div>
