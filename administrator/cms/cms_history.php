<?php
		...
		while($rows=$res->fetch(PDO::FETCH_ASSOC)){
			$strDesc=stripslashes($rows['historyDesc']);
		}
...
<h2 align="center">History</h2>
			...
			<form name="frmProducts" method="post" enctype="multipart/form-data" action="../support/crud1.php">
				...
				<div align="right">	<input name="add_history" type="submit" value="Save"><a href="../AboutUs.php"><input type="button" onclick="back()" value="Cancel" ></a></div>
			</form>
			</fieldset>	      
